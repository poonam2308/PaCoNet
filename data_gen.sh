...
#python pc/plot_gen/plots_processing.py --cfg pc/config/train_config.yaml --num_files 5000 --task run_dis
...
#python pc/plot_gen/plots_processing.py --cfg pc/config/train_config.yaml --task separate_by_color