...
#------------------------------------------crops -----------------------------------------------------------------------------
#./src/dhlp/eval-sAP_original.py ./outputs/results/crops


## --------------------------original SAP--------------------


#./src/dhlp/eval-sAP_original_crop.py ./outputs/results/c

#---------------------------------- cluster-----------------------------------------------------------------------------
#./src/dhlp/eval-sAP_original_crop.py  ./outputs/results/cls

#----------------------------------- color no unet-----------------------------------------------------------------------

#./src/dhlp/eval-sAP_original_crop.py ./outputs/results/nc

#----------------------------------- cluster no unet----------------------------------------------------------------------

./src/dhlp/eval-sAP_original_crop.py  ./outputs/results/ncls
